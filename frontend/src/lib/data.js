...
const SEED_CONTACTS = [
  ...
  { id: 'c4', name: 'David Kim', company: 'CMU Tepper', role: 'MBA Classmate', seniority: 'junior', relationshipType: 'Personal', tags: ['cmu', 'personal'], linkedinUrl: 'https://linkedin.com/in/davidkim', warmthScore: 68, warmthLabel: 'warm', lastContacted: iso(-5), nextFollowUp: iso(3), preferredChannel: 'text', createdAt: iso(-90), notes: 'Study group member. Working on consulting recruiting together.' },
  ...
  { id: 'c6', name: 'Marcus Johnson', company: 'Amazon', role: 'Senior Software Engineer', seniority: 'mid', relationshipType: 'Professional', tags: ['tech', 'amazon'], linkedinUrl: 'https://linkedin.com/in/marcusjohnson', warmthScore: 52, warmthLabel: 'lukewarm', lastContacted: iso(-10), nextFollowUp: iso(4), preferredChannel: 'linkedin', createdAt: iso(-30), notes: 'Spoke at CMU tech talk. Helpful about PM transitions.' },
